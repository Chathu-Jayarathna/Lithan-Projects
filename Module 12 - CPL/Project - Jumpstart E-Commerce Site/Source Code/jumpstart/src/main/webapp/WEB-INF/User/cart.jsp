		...
		<div class="cart-wrapper" style="margin-bottom: 3rem;">
			<div class="item-container">
					...
					<div class="cart-item">
						...
						<div class="ci-details">
							...
							<div class="ci-actions">
								<a class="delete"
									onclick="window.location.href='/remove_from_cart?cId=${c.id}'"><i class="fa fa-trash-o " style="font-size:25px;color:red"></i></a>
				...
				<c:if test="${empty cartItems }">
					<div class="flex-col align-center" style="background-color: var(--accent); border-radius: 10px; padding-bottom: 1.5rem;">
