...
<main>
	<div class="width-limiter align-center flex-col"
		...
		<div class="profile-container">
			<div class="img-wrapper">
				...
				<div>
					<button id="openEditProfile" class="action-btn edit btnAnimation"  style="margin-bottom: 2rem;font-size:1.0rem">
						Edit Profile</button>
	...
	<sec:authorize access="hasAnyRole('User')">
		<h2 class="section-heading hFont text-center" style="margin-top: 3rem;color: #5b0a47;">Order History</h2>
