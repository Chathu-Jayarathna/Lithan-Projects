	...
	<header id="navbar" class="no-select">
		...
		<div class="width-limiter justify-between">
			...
			<ul id="nav-links" class="align-center list-style-none hFont">
				<li><a href="/"><i class="fa fa-home" aria-hidden="true" style="color:#fff" ></i> Home</a></li>
				<li><a href="/about-us"><i class="fa fa-star" aria-hidden="true" style="color:#fff"></i> About Us</a></li>
				<li><a href="/contact-us"><i class="fa fa-phone" aria-hidden="true" style="color:#fff"></i> Contact Us</a></li>
