...
<main class="align-center" style="min-height: 95vh; background-image: url(/assets/banner.jpg);">
	<div class="width-limiter">
		...
		<div class="tb-containerl align-center justify-between">
			...
			<section class="tb-form flex-col">
				...
				<form id="registrationForm" class="form-card" autocomplete="off"
					...
					<input type="hidden" name="${_csrf.parameterName}"
						...
						placeholder="eg. ChathuDil07" autocomplete="off" maxlength="16" />
					</label> 
					
					<label class="input-group flex-col">Password <input
						id="password" type="password" required name="password" placeholder="eg. ChathuDil07"
			...
			<div class="tb-image disappear">
				<img alt="Registration Graphic" src="graphics/login.png">
			</div>
		</div>
	</div>
</main>
