...
<main>
	<div class="width-limiter" style="padding: 0rem 2rem;">
		...
		<section style="background-color: var(--accent); border-radius: 10px; margin-bottom: 3rem; padding: 0.5rem;">
			<h3 class="form-heading">Add a Product</h3>

			<sf:form class="flex-col align-center" style="gap: 0.5rem;"
				...
				<label class="input-group flex-col">Product Description <textarea
						required placeholder="Describe Product" rows="5"
...
<sf:form class="align-center flex-col form"
	...
	<label class="input-group flex-col">Category Name <input
		id="fullname" type="text" required="true" placeholder="e.g. Electronics"
