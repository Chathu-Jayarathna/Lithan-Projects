		...
		<form method="post" class="col-8" id="edit" action="${pageContext.request.contextPath}/update">
			...
			<div class="mb-3">
				<label class="form-label" for="inputname"> Name</label> <input
					type="text" class="form-control"  name="name" id="name" path="${user.name}
					 value="${user.name}"/>
			</div>
			<div class="mb-3">
				<label class="form-label" for="inputemail">Email</label> <input
					type="text" class="form-control" name="email" id="email" path="${user.email}
					value="${user.email}" />
			</div>
			<div class="mb-3">
				<label class="form-label" for="inputcity">City</label> <input
					type="text" class="form-control" name="city" id="city" path="${user.city}
					value="${user.city}" />
			</div>
			<div class="mb-3">
				<label class="form-label" for="inputname">Phone</label> <input
					type="text" class="form-control" name="contact" id="contact" path="${user.contact}
					value="${user.contact}" />
			</div>
