  ...
  <body>
    ...
    <main>
      <div class="container pt-5" >
        <div class="d-flex" >
          <!-- Sidebar -->
          <aside class="sidebar-user pe-md-3" style="background-color:#fff">
            <ul>
              <li>
              ...
              <li>
                <a href="<%= request.getContextPath() %>/user/test-drive"><i class="fa-solid fa-calendar-check"></i> Appointment</a>
              </li>
          ...
          <div class="content-wrapper">
            <h2 class="fw-bold mb-3" style="color:#fff">My Posted Cars</h2>
            <!-- Table -->
                    ...
                    <c:forEach items="${userCar}" var="car">
                      <tr>
                        ...
                        <c:if test="${!car.status.equals('SOLD')}">
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-warning dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fa fa-align-justify" aria-hidden="true" style="color:#000"></i></button>
            ...
            <c:if test="${userCar.isEmpty()}">
              ...
              <a href="<%= request.getContextPath() %>/user/post-car">
                <button class="btn btn-warning">Post Now</button>
              </a>
            </c:if>
          </div>
        </div>
