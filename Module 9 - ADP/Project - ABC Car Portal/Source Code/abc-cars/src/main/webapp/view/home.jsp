    ...
    <main>
        ...
        <div class="container d-flex justify-content-center align-items-center">
          <div class="jumbotron-content pt-4">
            ...
            <div class="jumbotron-text ">
              <h2 class="fw-bolder m-0">ONE - STEP SOLUTION</h2>
              <h2 class="fw-bolder">FOR ALL YOUR VEHICLE SOLUTIONS</h2>
      ...
      <div class="container mt-4 p-3">
        <div class="d-flex justify-content-between">
          <h2 class="fw-bolder" style="color:#fff">Featured Cars</h2>
          <a class="text-decoration-none" href="<%= request.getContextPath() %>/cars" style="color:#fff">See all cars</a>
        </div>
              ...
              <div class="card">
                ...
                <div class="card-body" >
                  ...
                  <a href="<%= request.getContextPath() %>/cars/${car.make}/${car.model}/${car.year}/${car.idCar}">
                    <button class="btn btn-warning">Car Details</button>
                  </a>
                </div>
              </div>
            </div>
