<nav class="navbar navbar-expand-lg sticky-top p-0" style="background-color:#000">
  <div class="container">
  <img class="image-about" src="/images/all/abccars-logo.png" style="width:220px" />

    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      <span class="navbar-toggler-icon"></span>
    </button>
    <div class="collapse navbar-collapse" id="navbarNav" >
      <ul class="navbar-nav ms-auto me-0 me-lg-left fw-semibold" >
      ...
      <security:authorize access="!isAuthenticated()">
        <div class="nav-button d-flex flex-column flex-lg-row">
          <a href="<%= request.getContextPath() %>/login" class="btn btn-outline-warning me-0 me-lg-3 mb-3 mb-lg-0">Login</a>
          <a href="<%= request.getContextPath() %>/register" class="btn btn-warning mb-3 mb-lg-0" >Register</a>
        </div>
      </security:authorize>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <a class="dropdown-item" href="<%= request.getContextPath() %>/logout">
                  <button class="nav-logout btn btn-warning">Logout</button>
                </a>
              </li>
            </ul>
          </li>
