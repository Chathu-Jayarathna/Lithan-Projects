          ...
          <div class="car-list">
            ...
            <div class="mt-4 row">
              ...
              <div class="car-details col-12 col-sm-4">
                ...
                <p class="text-light m-0">STARTING PRICE:</p>
                <p class="text-warning fs-5">$${car.price}</p>
                <c:if test="${highestBidding != 0}">
                  <p class="text-light m-0">HIGHEST BID:</p>
                  <p class="text-warning fs-5">$${highestBidding}</p>
                </c:if>
                <c:if test="${highestBidding == 0}">
                  <p class="text-light m-0">HIGHEST BID:</p>
                  <p class="text-warning fs-5">$${highestBidding}</p>
                ...
                <div class="car-button-actions">
                  <a class="text-decoration-none" href="<%= request.getContextPath() %>/car-bid?id=${car.idCar}">
                    <button class="btn btn-danger">Place Bid</button>
                  </a>
