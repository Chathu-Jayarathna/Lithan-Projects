			...
			<div class="form-wrapper small">
				<div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
					...
					<form:form action="loginUser" method="POST" modelAttribute="user">
						...
						<button class="btn btn-warning mt-2 form-button" type="submit">Login</button>

						<div class="mt-3 text-center">
							<a href="<%=request.getContextPath()%>/register"
								class="text-decoration-none">Not a Member? Register Now</a>
						</div>

						<img class="image-about" src="/images/all/login.jpg" alt=""
