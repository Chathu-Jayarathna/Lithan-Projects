...
public class MealsOnWheelsBackEndApplication {
	...
	CommandLineRunner initRunner(CustomerRepository customerRepository, PasswordEncoder passwordEncoder,
		...
		return args -> {
			...
			partner.setAddress("Kandy, Sri Lanka");
			partner.setEmail("abccompany@gmail.com");
			...
			member.setName("Tamim");
			member.setAddress("Dhaka, Bangladesh");
			member.setGender(EGender.MALE);
			member.setRole(ERole.ROLE_MEMBER);
			member.setEmail("tamim@gmail.com");
			...
			rider.setName("Chathu");
			rider.setAddress("Kandy, Sri Lanka");
			rider.setGender(EGender.MALE);
			rider.setRole(ERole.ROLE_RIDER);
			rider.setEmail("chathu@gmail.com");
			...
			volunteer.setName("Hashini");
			volunteer.setAddress("Matara, Sri Lanka");
			volunteer.setGender(EGender.MALE);
			volunteer.setRole(ERole.ROLE_VOLUNTEER);
			volunteer.setEmail("hashini@gmail.com");
