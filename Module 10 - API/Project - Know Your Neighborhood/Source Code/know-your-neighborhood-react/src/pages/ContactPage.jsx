      ...
      <section className="flex justify-center text-primary px-6 mt-8">
        <div className="max-w-[1280px] w-full">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10">
            <form className="flex flex-col space-y-5 p-5 border shadow bg-black-200">
            ...
            <div className="flex flex-col space-y-5 p-5 border shadow bg-black-200 text-lg">
              <div className="text-center space-y-2">
                ...
                <p>St.Chathu,mth,Diyathilawa,Bandarwella,Sri-Lanka</p>
              </div>
              <div className="text-center space-y-2">
                <i className="fa-regular fa-envelope text-4xl" />
                <p>knowmyneighbours12@business.email.com</p>
              </div>
              <div className="text-center space-y-2">
                <i className="fa-solid fa-phone text-4xl" />
                <p>+987654321, 0123456789</p>
              </div>
            </div>
          </div>
        </div>
