...
<link href="resource/css/jobcss.css" rel="stylesheet" />
<head>
<meta charset="UTF-8">
...
<body>
	<f:form action="postjob" modelAttribute="job" method="post"
		...
		<label for="name" class="form-label">Job catagory</label>
